...
// Anti link
 ...
 hehe = `
 T⃠ 🅷︎🅸︎ @${sender.split("@")[0]}
 E⃠ 🅿︎🆁︎🅸︎🆅︎🅰︎🆃︎🅴︎ : ${privat.length}
 D⃠ 🅶︎🆁︎🅾︎🆄︎🅿︎🆂︎ : ${groups.length}
 Z⃠ 🆃︎🅾︎🆃︎🅴︎🅻︎ : ${totalChat.length}
 O⃠ 🆂︎🅿︎🅴︎🅴︎🅳︎ : ${latensie.toFixed(4)}
 O⃠ 🅱︎🅰︎🆃︎🆃︎🅰︎🆁︎🆈︎ : ${baterai}%\n
 ${jmn} -  ${jmo}\n${week} - ${calender}
 `
